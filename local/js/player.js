...
function Player(id, name){
	...
	sprite.animations.add('punch',[0,1,2,3], 12, true);
	sprite.animations.add('punchLeft',[3,2,1,0], 12, true);
	sprite.animations.add('jump', [0,1,2,3], 12, false);
	sprite.animations.add('jumpLeft', [3,2,1,0], 12, false);
